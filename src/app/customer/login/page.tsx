    ...
    <div style={containerStyle}>
      <div className="card" style={cardStyle}>
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          ...
          <h2 style={{ color: '#fff', fontSize: '24px', fontWeight: 800 }}>Customer Portal</h2>
          <p style={{ fontSize: '13px', color: 'var(--text-muted)' }}>Sign in to browse shows and book tickets.</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            ...
            disabled={submitting}
          >
            {submitting ? 'Authenticating...' : 'Sign In as Customer'}
          </button>
        </form>

        <p style={registerPromptStyle}>
          Don&apos;t have an account?{' '}
          <Link href="/customer/register" style={{ color: 'var(--primary)', fontWeight: 600 }}>
